...
async function main(): Promise<void> {
  ...
  await emitJson(outDir, "meta.json", {
    sourceVendor: "Prusa Research + Bambu Lab",
    sourceFile: "PrusaResearch.ini, BambuStudio BBL profiles",
    sourceConfigVersion: configVersion,
    sourceFileSha256_16: sourceHash,
    ingestedAt: new Date().toISOString(),
    license: "AGPL-3.0-or-later",
    attribution:
      "Printer and filament defaults are seeded from Prusa Research's official PrusaSlicer configuration bundle and Bambu Lab's official BambuStudio configuration bundle (both AGPLv3). See docs/licensing/THIRD_PARTY_PRUSASLICER.md and docs/licensing/THIRD_PARTY_BAMBUSTUDIO.md.",
