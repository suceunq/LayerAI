...
export function ProjectRecoveryDialog(): React.JSX.Element {
  ...
  return (
    <div className="absolute inset-0 z-50 flex items-center justify-center bg-black/70 p-6" role="dialog" aria-modal="true" aria-labelledby="recovery-title">
      <div className="w-full max-w-md rounded-2xl border border-accent/40 bg-surface-1 p-6 shadow-2xl">
