...
const api: LayerAiApi = {
  ...
  getProjectRecovery: () => ipcRenderer.invoke(IpcChannels.projectRecoveryGet),
  saveProjectRecovery: (request) => ipcRenderer.invoke(IpcChannels.projectRecoverySave, request),
  clearProjectRecovery: () => ipcRenderer.invoke(IpcChannels.projectRecoveryClear),
